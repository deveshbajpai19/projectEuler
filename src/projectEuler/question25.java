...
//the middle element (intersection point of both diagonal is added twice; subtract its value once from the sum)

obj.diagonalElemSum -= 1;

System.out.println("\nSum of diagonal elements is:"+obj.diagonalElemSum);
